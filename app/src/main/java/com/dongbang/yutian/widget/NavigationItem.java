...
import com.dongbang.yutian.utils.DensityUtil;


/**
 * Created by hayquan on 2016/6/13.
 */
public class NavigationItem extends LinearLayout
{
    ...
    public void setTextVisible(boolean textVisible)
    {
        ...
        mTextView.setVisibility(textVisible
                ? VISIBLE
                : GONE);
        if (!textVisible)
        {
    ...
    public void setImageVisible(boolean imageVisible)
    {
        ...
        mImageView.setVisibility(imageVisible
                ? VISIBLE
                : GONE);
    }
    ...
    public void showView()
    {
        ...
        mImageView.setVisibility(imageVisible
                ...
                : GONE);
        mTextView.setTextSize(textSize);
        setPadding(0, DensityUtil.dip2px(getContext(), imagePaddingTop), 0, DensityUtil.dip2px(getContext(), textPaddingBottom));
