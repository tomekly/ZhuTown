...
//            mPaint.setAntiAlias(true);
        ...
        canvas.save();
        canvas.scale(1,-1);
        canvas.drawText(unitX,horizontal,(mPaint.descent()+mPaint.ascent())-vertical/50,mPaint);
        canvas.restore();
        //Y轴
        ...
        canvas.save();
        canvas.scale(1,-1);
        canvas.drawText(unitY,-mPaint.measureText(unitY),-vertical+(mPaint.descent()+mPaint.ascent())*2,mPaint);
        canvas.restore();
        mPath.rewind();//清除
        mPaint.setAntiAlias(true);
